 ...
 */
class TaskMemberRemovedEvent extends \Ora\TaskManagement\TaskMemberRemovedEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaskMemberRemovedEvent $proxy) {
