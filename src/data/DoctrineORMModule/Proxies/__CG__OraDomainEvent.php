...
namespace DoctrineORMModule\Proxy\__CG__\Ora;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class DomainEvent extends \Ora\DomainEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ora\\DomainEvent' . "\0" . 'id', '' . "\0" . 'Ora\\DomainEvent' . "\0" . 'firedAt', 'aggregateId', 'attributes');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DomainEvent $proxy) {
