 ...
 */
class Estimation extends \Ora\ReadModel\Estimation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ora\\ReadModel\\Estimation' . "\0" . 'taskMember', '' . "\0" . 'Ora\\ReadModel\\Estimation' . "\0" . 'value', 'id', 'createdAt', 'createdBy', 'mostRecentEditAt', 'mostRecentEditBy');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Estimation $proxy) {
