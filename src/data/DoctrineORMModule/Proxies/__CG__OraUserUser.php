...
class User extends \Ora\User\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ora\\User\\User' . "\0" . 'firstname', '' . "\0" . 'Ora\\User\\User' . "\0" . 'lastname', '' . "\0" . 'Ora\\User\\User' . "\0" . 'email', '' . "\0" . 'Ora\\User\\User' . "\0" . 'status', 'id', 'createdAt', 'createdBy', 'mostRecentEditAt', 'mostRecentEditBy', 'version', 'recordedEvents');
        }
