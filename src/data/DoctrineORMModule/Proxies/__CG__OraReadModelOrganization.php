 ...
 */
class Organization extends \Ora\ReadModel\Organization implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ora\\ReadModel\\Organization' . "\0" . 'subject', 'id', 'createdAt', 'createdBy', 'mostRecentEditAt', 'mostRecentEditBy');
        }
