 ...
 */
class TaskCreatedEvent extends \Ora\TaskManagement\TaskCreatedEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'task', 'aggregateId', 'attributes');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaskCreatedEvent $proxy) {
