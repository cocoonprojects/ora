...
namespace DoctrineORMModule\Proxy\__CG__\Ora\Accounting;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class CreditsAccount extends \Ora\Accounting\CreditsAccount implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ora\\Accounting\\CreditsAccount' . "\0" . 'balance', 'id', 'createdAt', 'createdBy', 'mostRecentEditAt', 'mostRecentEditBy', 'version', 'recordedEvents');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CreditsAccount $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setBalance(\Ora\Accounting\Balance $balance)
    {
