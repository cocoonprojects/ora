 ...
 */
class TaskDeletedEvent extends \Ora\TaskManagement\TaskDeletedEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaskDeletedEvent $proxy) {
