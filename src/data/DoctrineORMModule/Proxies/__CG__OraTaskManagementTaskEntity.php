 ...
 */
class TaskEntity extends \Ora\TaskManagement\TaskEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ora\\TaskManagement\\TaskEntity' . "\0" . 'description', '' . "\0" . 'Ora\\TaskManagement\\TaskEntity' . "\0" . 'project');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaskEntity $proxy) {
