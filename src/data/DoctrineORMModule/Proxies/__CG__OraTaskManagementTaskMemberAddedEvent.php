 ...
 */
class TaskMemberAddedEvent extends \Ora\TaskManagement\TaskMemberAddedEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaskMemberAddedEvent $proxy) {
