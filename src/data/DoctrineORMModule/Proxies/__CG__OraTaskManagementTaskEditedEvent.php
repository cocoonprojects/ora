 ...
 */
class TaskEditedEvent extends \Ora\TaskManagement\TaskEditedEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaskEditedEvent $proxy) {
