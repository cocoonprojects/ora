...
Scenario: Successfully accepting an existing already accepted Kanbanize Task
	...
	When I request "/taskmanagement/tasks/00000000-0000-0000-0000-000000000008/transitions"
	Then the response status code should be 204
	
Scenario: Successfully accepting an existing completed Kanbanize Task
	Given that i want to make a new "Task"
	And that its "status" is "accepted"
	When I request "/taskmanagement/tasks/00000000-0000-0000-0000-000000000009/transitions"
	Then the response status code should be 200

Scenario: Cannot accept an existing ongoing Kanbanize Task
	Given that i want to make a new "Task"
	And that its "status" is "accepted"
	When I request "/taskmanagement/tasks/00000000-0000-0000-0000-000000000010/transitions"
	Then the response status code should be 400
	
Scenario: Succesfully moving a completed Kanbanize Task to ongoing
	Given that i want to make a new "Task"
	And that its "status" is "ongoing"
	When I request "/taskmanagement/tasks/00000000-0000-0000-0000-000000000011/transitions"
	Then the response status code should be 200
...
Scenario: Cannot accept a non existing Kanbanize Task
	Given that i want to make a new "Task"
	And that its "status" is "accepted"
	When I request "/taskmanagement/tasks/00000000-0000-0000-0000-000088888888/transitions"
