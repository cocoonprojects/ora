...
Scenario: Successfully getting organization account
	...
	When I request "/00000000-0000-0000-1000-000000000000/accounting/accounts/dcde992b-5aa9-4447-98ae-c8115906dcb7"
...
Scenario: Successfully getting organization account statement
	Given that I am authenticated as "mark.rogers@ora.local"
	And that I want to find a "Account"
	When I request "/00000000-0000-0000-1000-000000000000/accounting/accounts/dcde992b-5aa9-4447-98ae-c8115906dcb7/statement"
	Then the response status code should be 200
	And the response should be JSON
	And the response should have a "balance" property
